...
It is intended as a quick one-stop reference/cookbook for the various `tidyverse` packages and their functions.
...
This website is split into sections for each of the main packages in tidyverse.
These are:
...
- [forcats](/forcats/forcats.qmd): Factor manipulation (in development)
- [purrr](/purrr/purrr.qmd): Functions & vectors (in development)
- [lubridate](/lubridate/lubridate.qmd): Data-time data (in development)

::: {.callout-tip}
Hexagonal images, such as the 9 at the top of this page, can be clicked on to bring you to the package/function webpage.
You can also right click and open link in new tab, or click with your middle mouse button to open the page in a new tab.
:::
...
Optionally you can run through `learnr` tutorials made for this website: [`learnr` course](/learnr.qmd)
...
[Update tidyverse packages](https://tidyverse.tidyverse.org/reference/tidyverse_update.html)

::: {.callout-tip collapse="true" title="Run on course webVNC instead"}
We recommend you run through the [learnr tutorials](/learnr.qmd) on your own computer with RStudio.
