...
__Tip:__ Hexagonal images, such as the 9 at the top of this page, can be clicked on to bring you to the package/function webpage.
You can also right click and open link in new tab, or click with your middle mouse button to open the page in a new tab.

__Note:__ The sections marked with "in development" are currently empty.
