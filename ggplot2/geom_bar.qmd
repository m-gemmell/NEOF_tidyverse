...
In this page we will create bar chart with `ggplot2::geom_bar()`.
...
Then we'll remove any rows with an NA value using [`tidyr::drop_na`](/tidry/drop_na.qmd).
...
ALthough __absoulte count__ values are useful for __bar charts__ you will sometimes want __relative proporitions__.
