...
Notice the scale difference (i.e where the points and values are placed) but the actual values are the same (i.e. x values go from 0-50 and y values go from 0 to 20).
