...
These bin counts are displayed as a bar chart.
...
However, the best method on choosing a value is to create the default plot first and then experiment with bin numbers afterwards.
