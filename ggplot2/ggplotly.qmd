...
This works with python, R, `ggplot2`, and other languages. You can create plots with plotly's own library in R. However, we'll demonstrate how to plotlyfy plots with `ggplot2` using `ggplotly()`.

The package `plotly` is separate to `tidyverse` and therefore needs installing.

[Install instruction](https://plotly.com/r/getting-started/)
...
[Plotly ggplotly reference page](https://plotly.com/ggplot2/)
...
To create a plotly plot we'll first create a ggplot pbject
...
Try interacting with the below plot.
