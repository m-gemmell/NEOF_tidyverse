...
This is carried out below with the [match operator (`%in%`)](https://stat.ethz.ch/R-manual/R-devel/library/base/html/match.html).
...
bison_tbl |> dplyr::filter(animal_code %in% animal_codes)
```
