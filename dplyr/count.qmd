...
The function `count()` counts the number of observations/rows for each unique value within one or more variables.
I.e. you can count the number of rows each group represents.
