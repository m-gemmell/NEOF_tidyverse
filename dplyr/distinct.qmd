...
For demonstration we’ll load and subset the knz_bison data from the [lterdatasampler package](/datasets/lterdatasampler.qmd) (hyperlink includes install instructions). This time we will ensure to duplicate rows.
