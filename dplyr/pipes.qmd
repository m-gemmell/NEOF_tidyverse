...
__Note:__ Pipes are not only limited to `tidyverse` functions.
...
The below code carries out the steps but in a less visually clear method with nested functions.
