...
This space delimited file was created with the [`readr::write_delim()`](/readr/write.qmd#space-delimited) and only contains the header line plus the first 5 rows of the __all_plant_details.csv__ file.
