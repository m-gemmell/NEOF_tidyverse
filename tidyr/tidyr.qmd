...
- [__`pivot_longer()`__](/tidyr/pivot_longer.qmd): Lengthens data, transforming it from wide to long. Many __Tidyverse__ packages are built with long data in mind, especially [`ggplot2`](/ggplot2/ggplot2.qmd).
