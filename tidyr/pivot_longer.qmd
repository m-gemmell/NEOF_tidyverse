...
The function `pivot_longer()` longifies data, converting it from wide to long.
...
- The column names are assigned as the data within a __names__ column
- The values within the columns' cells are assigned to a __value__ column
    - Each value is within its own row
