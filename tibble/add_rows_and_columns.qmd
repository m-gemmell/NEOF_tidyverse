...
Before demonstrating various examples we will create a couple __tibbles__.
...
Adding one new column or row can be carried out with the intuitively named functions:
...
In the below example the new column will have the name `aa`.
