...
Below we load and subset the `hbr_maples` data from the [lterdatasampler package](/datasets/lterdatasampler.qmd) (hyperlink includes install instructions) and view it.

```{r}
#Load package
library("lterdatasampler")
#Subset of hbr_maples tibble
tibble::as_tibble(lterdatasampler::hbr_maples)[1:10,1:8]
```
